        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-col">
            <div class="h-1 bg-gray-200 rounded overflow-hidden">
              <div class="w-36 h-full bg-indigo-500"></div>
            </div>
            ...
            <div className="overflow-hidden rounded-lg border border-gray-200 shadow-md">
              <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
                ...
                <tbody className="divide-y divide-gray-100 border-t border-gray-100 h-48">
                  {complaints &&
                    complaints
                      .filter((elem) => elem.complaintStatus == "assigned")
                      .map((elem) => (
                        <tr className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4">
                            <div className="inline-flex items-center rounded-full px- py-1 text-xl ">
                              <span class="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-1 text-md font-semibold text-blue-500">
...
export default AdminComplaintAssign;